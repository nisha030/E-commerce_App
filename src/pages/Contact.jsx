  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Fashion Street<br />New York, NY 10001<br />United States</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@trendora.com<br />support@trendora.com</p>
                </div>
              </div>
        ...
        <div className="mt-20">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Visit Our Store</h2>
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img 
              src={assets.contact_img} 
              alt="Trendora Store Location" 
            ...
            <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <p className="text-xl font-semibold mb-2">123 Fashion Street</p>
                <p className="text-lg opacity-90">New York, NY 10001</p>
              </div>
            </div>
          </div>
        </div>
