      ...
      <div>
        {
          cartData.map((item, index)=>{
            ...
            return(
              <div key={index} className="py-2 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4">
                ...
                <div className="flex items-center gap-5 mt-2">
                  ...
                  <p className="px-2 sm:px-3 sm:py-1 text-black-50 border border-slate-500 rounded-md">{item.size}</p>
                </div>
                </div>
                </div>
